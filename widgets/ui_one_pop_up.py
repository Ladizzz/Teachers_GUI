...
################################################################################
## Form generated from reading UI file 'one_pop_upWTYSBy.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_to_favorites = QPushButton(self.frame_header)
        self.btn_to_favorites.setObjectName(u"btn_to_favorites")
        self.btn_to_favorites.setMinimumSize(QSize(0, 0))
        icon = QIcon()
        icon.addFile(u"icons/alarm-clock-blue_24_24.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_to_favorites.setIcon(icon)
        self.btn_to_favorites.setIconSize(QSize(16, 16))
        self.btn_to_favorites.setAutoDefault(False)
        self.btn_to_favorites.setFlat(True)

        self.horizontalLayout_2.addWidget(self.btn_to_favorites)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_to_favorites.setText(QCoreApplication.translate("Form", u"\u0412 \u0438\u0437\u0431\u0440\u0430\u043d\u043d\u043e\u0435", None))
